...
<svelte:head>
	...
	<meta name="description" content="DeepSquare's Terms of Use." />
</svelte:head>
	...
	<ol>
		...
		<li>
			...
			<ol>
				...
				<li>
					Personal information that you supply to us, and any information about your use of the Site
					that we obtain will be subjected to our Data Protection Policy.
				</li>
			</ol>
		</li>
		<li>
		...
		<li>
			...
			<ol type="a">
				...
				<li>
					Copy, use, disclose or distribute any information obtained from the Site, whether directly
					or through third parties, without our consent;
				</li>
				<li>Use, disclose or distribute any data obtained in violation of these Terms;</li>
				<li>
				...
				<li>
					Violate our intellectual property or other rights, including, without limitation:<br />
					<ol type="i">
						<li>copying or distributing our materials</li>
						<li>
							copying or distributing our technology, unless it is released under open source
							licenses;
						</li>
						<li>
							using the word “DeepSquare Project” or our logos in any business name, email, or URL,
							without our consent;
						</li>
					</ol>
				</li>
				<li>
					Imply or state that you are affiliated with or endorsed by DeepSquare Project without our
					express consent;
				</li>
				<li>Rent, lease, loan, trade, sell/resell access to the Site or related data;</li>
				<li>
					Act in an unlawful or unprofessional manner in connection with our Services, including
				...
				<li>
					Send or post any unsolicited or unauthorized advertising, “junk mail,” “spam,” “chain
					letters,” “pyramid schemes,” or any form of solicitation unauthorized by us;
				</li>
				<li>
					Disclose information that you do not have the consent to disclose, such as confidential
					information of others;
				</li>
				<li>Post content that contains software viruses, worms, or any other harmful code;</li>
				<li>
					...
					manual work) to scrape the Site or otherwise copy data from the Site;
				</li>
				<li>Bypass or circumvent any access controls or Site use limits;</li>
				<li>
					Reverse engineer, decompile, disassemble, decipher or otherwise attempt to derive the
					source code for the Site or any related technology that is not open source;
				</li>
				<li>
					Monitor the Site’s availability, performance or functionality for any competitive purpose;
				</li>
				<li>
					Engage in “framing,” “mirroring,” or otherwise simulating the appearance or function of
					the Site;
				</li>
				<li>
					Access the Site except through the interfaces through the interfaces that are not provided
					as legitimate in our consideration;
				</li>
				<li>Override any security feature of the Site;</li>
				<li>
					Interfere with the operation of the DeepSquare website, as also place any undesirable or
		...
		<li>
			...
			<ol>
				...
				<li>
					You may not reproduce, reprint, publish, or otherwise exploit our’ content or technology
		...
		<li>
			...
			<ol>
				...
				<li>
					If you post any content on the public space of this Site, you grant us the perpetual
		...
		<li>
			...
			<ol>
				...
				<li>
					You further agree that any disputes or claims that you may have against us will be
					...
					action.<br />By agreeing to these terms of use, you are:<br />
					<ol type="a">
						<li>
							Waiving claims that you might otherwise have against us based on the laws of other
							jurisdictions, including your own;
						</li>
						<li>
							Irrevocably consenting to the exclusive jurisdiction of the courts based in
							Switzerland over any disputes or claims you have with us;
						</li>
						<li>
							Submitting yourself to the personal jurisdiction of Swiss courts for the purpose of
							resolving any disputes or claims arising from your activity on DeepSquare platform.
						</li>
					</ol>
				</li>
			</ol>
		...
		<li>
			...
			<ol>
				<li>
					...
					part, to any natural or legal person.
				</li>
				<li>
					You may not assign, sublicense or otherwise transfer in any manner any of your rights or
		...
		<li>
			...
			<ol type="a">
				...
				<li>
					a description of where the material believed to be infringed is located (please be as
					detailed as possible and provide a URL to help us locate the material you are reporting);
				</li>
				<li>
					contact information for the complaining party, such as a complete name, address, telephone
		...
		<li>
			...
			<p>
				If you in *any* way impersonate or act as you represent DeepSquare project, your affiliate
			...
			<p>
				You are not allowed to post your referral link in DeepSquare social media pages (Twitter,
				Facebook, Reddit etc.)
			</p>
		</li>
		<li>
			Any referral credits for referred purchases after a soft cap of USD $5,000,000 is reached can
		...
		<li>
			...
			<ul>
				<li>
					...
					Tokens or in any manner involving a public offering in the United States of America;
				</li>
				<li>
					is not subject and is not a resident of a jurisdiction that is subject to economic
					...
					another authority having jurisdiction over the Investor or his /her/its assets
				</li>
			</ul>
		</li>
	</ol>
